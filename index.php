...
<body>
                ...
                <ul class="nav-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="/imk/logistikmaritim/html/tentang.php">Tentang Perusahaan</a></li>
                            <li><a href="/imk/logistikmaritim/html/fasilitas.php">Fasilitas dan Pelayanan</a></li>
                            <li><a href="/imk/logistikmaritim/html/jaminan.php">Jaminan Pelayanan</a></li>
                            <li><a href="/imk/logistikmaritim/html/syarat.php">Syarat dan Ketentuan</a></li>
                            <li><a href="/imk/logistikmaritim/html/informasi.php">Informasi Pengiriman</a></li>
                            <li><a href="/imk/logistikmaritim/html/karir.php">Karir</a></li>
                            <li><a href="/imk/logistikmaritim/html/tim.php">Tim</a></li>
                        </ul>
                    </li>
            ...
            <div class="auth-buttons">
                <?php if (isLoggedIn()): ?>
                    <div class="user-menu">
                        ...
                        <a href="/imk/dashboard.php" class="btn-dashboard">Dashboard</a>
                        <a href="/imk/logout.php" class="btn-logout">Logout</a>
                    </div>
                <?php else: ?>
                    <a href="/imk/login.php" class="btn-login">Masuk</a>
                    <a href="/imk/register.php" class="btn-signup">Daftar</a>
                <?php endif; ?>
            </div>
        ...
        <div class="mobile-menu">
            <ul class="mobile-nav-menu">
                ...
                <?php if (isLoggedIn()): ?>
                    ...
                    <li><a href="/imk/logout.php">Logout</a></li>
                <?php else: ?>
                    <li><a href="/imk/login.php">Masuk</a></li>
                    <li><a href="/imk/register.php">Daftar</a></li>
                <?php endif; ?>
            </ul>
        </div>
    </header>
    ...
    <section class="hero" id="beranda">
        <div class="hero-container">
            <div class="hero-content">
                ...
                <?php if (isLoggedIn()): ?>
                    <a href="/imk/dashboard.php" class="cta-button">
                        Dashboard
                    </a>
                <?php else: ?>
                    <a href="/imk/login.php" class="cta-button">
        ...
        <div class="content-container">
            <div class="content-item">
                <div class="content-image">
                    <img src="/imk/logistikmaritim/image/2.png" alt="Port Container" />
                </div>
                <div class="content-text">
                    ...
                    <a href="/imk/logistikmaritim/html/tentang.php" class="selengkapnya-btn">Selengkapnya →</a>
                </div>
            </div>

            <div class="content-item">
                <div class="content-image">
                    <img src="/imk/logistikmaritim/image/3.png" alt="Logistics Service" />
                </div>
                <div class="content-text">
                    <h3>PELAYANAN</h3>
                    ...
                    <a href="/imk/logistikmaritim/html/fasilitas.php" class="selengkapnya-btn">Selengkapnya →</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="highlight-container">
            ...
            <div class="highlight-grid">
                <div class="highlight-card">
                    <img src="/imk/logistikmaritim/image/4.png" alt="Visi Misi" />
                    <h4>Visi & Misi</h4>
                    ...
                    <a href="/imk/logistikmaritim/html/tentang.php" class="selengkapnya-btn1a">Selengkapnya →</a>
                </div>
                <div class="highlight-card">
                    <img src="/imk/logistikmaritim/image/5.png" alt="Karir" />
                    <h4>Karir</h4>
                    ...
                    <a href="/imk/logistikmaritim/html/karir.php" class="selengkapnya-btn1b">Selengkapnya →</a>
                </div>
                <div class="highlight-card">
                    <img src="/imk/logistikmaritim/image/6.png" alt="Syarat Ketentuan" />
                    ...
                    <a href="/imk/logistikmaritim/html/syarat.php" class="selengkapnya-btn1c">Selengkapnya →</a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="partners-grid">
                <div class="partner-logo">
                    <a href="https://www.asus.com/" target="_blank">
                        <img src="/imk/logistikmaritim/image/asus.png" alt="ASUS" />
                    </a>
                </div>
                <div class="partner-logo">
                    <a href="https://www.shopee.com/" target="_blank">
                        <img src="/imk/logistikmaritim/image/shoope.png" alt="Shopee" />
                    </a>
                </div>
                <div class="partner-logo">
                    <a href="https://www.komatsu.com/" target="_blank">
                        <img src="/imk/logistikmaritim/image/komatsu.png" alt="Komatsu" />
                    </a>
                </div>
                <div class="partner-logo">
                    <a href="https://www.adidas.com/" target="_blank">
                        <img src="/imk/logistikmaritim/image/adidas.png" alt="Adidas" />
                    </a>
                </div>
                <div class="partner-logo">
                    <a href="https://www.tokopedia.com/" target="_blank">
                        <img src="/imk/logistikmaritim/image/tokopedia.png" alt="Tokopedia" />
                    </a>
                </div>
                <div class="partner-logo">
                    <a href="https://www.bukalapak.com/" target="_blank">
                        <img src="/imk/logistikmaritim/image/bukalapak.png" alt="Bukalapak" />
                    </a>
                </div>
                <div class="partner-logo">
                    <a href="https://www.advan.id/" target="_blank">
                        <img src="/imk/logistikmaritim/image/advan.png" alt="Advan" />
                    </a>
                </div>
                <div class="partner-logo">
                    <a href="https://www.iphone.com/" target="_blank">
                        <img src="/imk/logistikmaritim/image/iphone.png" alt="iPhone" />
                    </a>
                </div>
                <div class="partner-logo">
                    <a href="https://www.yamaha.com/" target="_blank">
                        <img src="/imk/logistikmaritim/image/yamaha.png" alt="Yamaha" />
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="footer-section">
                ...
                <div class="social-icons">
                    <a href="#" class="social-icon">
                        <img src="/imk/logistikmaritim/image/wa.png" alt="WhatsApp">
                    </a>
                    <a href="#" class="social-icon">
                        <img src="/imk/logistikmaritim/image/ig.png" alt="Instagram">
                    </a>
                    <a href="#" class="social-icon">
                        <img src="/imk/logistikmaritim/image/fb.png" alt="Facebook">
                    </a>
                </div>
            </div>
        </div>
    ...
    <script src="/imk/logistikmaritim/js/script.js"></script>
</body>
</html> 