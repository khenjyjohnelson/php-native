                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="admin.php?page=databarang">Data1</a>
                                    <a class="nav-link" href="admin.php?page=databkategori">Data2</a>
                                    <a class="nav-link" href="admin.php?page=datasupplier">Data3</a>
                                    <a class="nav-link" href="admin.php?page=datauser">Data4</a>
                                </nav>
                            </div>
