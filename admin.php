...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="">Inventory Property</a>
                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="admin.php?page=databarang">Data Bangunan</a>
                                <a class="nav-link" href="admin.php?page=databkategori">Data Listing (Agent)</a>
                                <a class="nav-link" href="admin.php?page=datakategori">Data Kategori</a>
                                <a class="nav-link" href="admin.php?page=dataowner">Data Owner</a>
                                <a class="nav-link" href="admin.php?page=datakontak">Data Kontak</a>
                                <a class="nav-link" href="admin.php?page=datalokasi">Data Lokasi</a>
